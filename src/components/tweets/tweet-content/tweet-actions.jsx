  ...
  return (
    <div className="tweet-actions flex justify-center items-center gap-12 text-[grey] text-base">
      <div className="tweet-action hoverReply flex items-center justify-center gap-1.5 cursor-pointer relative">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='hoverReplyIcon w-4 h-auto text-[#2f3336]'>
        ...
        <span className="hoverReplyText">{replyValue}</span>
      </div>
      <div className="tweet-action hoverRetweet flex items-center justify-center gap-1.5 cursor-pointer relative">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='hoverRetweetIcon w-4 h-auto text-[#2f3336]'>
        ...
        <div className="svg-border"></div>
        <span className="hoverRetweetText">{retweetValue}</span>
      </div>
      <div className={`tweet-action hoverReact flex items-center justify-center gap-1.5 cursor-pointer relative ${isLiked && 'isLikedBox'}`} onClick={handleClickOnLikeButton}>
        {/* <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`hoverReactIcon ${isLiked ? 'islike' : ''}`}>
          <path d="M12 21.638H11.986C9.40295 21.59 1.94995 14.856 1.94995 8.478C1.94995 5.414 4.47495 2.724 7.35295 2.724C9.64295 2.724 11.183 4.304 11.999 5.454C12.813 4.306 14.353 2.724 16.644 2.724C19.524 2.724 22.048 5.414 22.048 8.479C22.048 14.855 14.594 21.589 12.011 21.636H12V21.638ZM7.35395 4.225C5.27395 4.225 3.45095 6.213 3.45095 8.48C3.45095 14.22 10.485 20.076 12.001 20.138C13.519 20.076 20.551 14.221 20.551 8.48C20.551 6.213 18.728 4.225 16.648 4.225C14.12 4.225 12.708 7.161 12.696 7.19C12.466 7.752 11.54 7.752 11.309 7.19C11.295 7.16 9.88395 4.225 7.35495 4.225H7.35395Z" fill="#D9D9D9" className={isLiked && 'isFilled'}/>
        </svg> */}
        {isLiked ? (
          <i className="ri-heart-fill svgRemix isFilled"></i>
        ) : (
          <i className="ri-heart-line svgRemix"></i>
        )}
        <div className="svg-border"></div>
        <span className={`hoverReactText ${isLiked && 'isLiked'}`}>{likeTweet}</span>
      </div>
      <div className="tweet-action hoverShare flex items-center justify-center gap-1.5 cursor-pointer relative">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='hoverShareIcon w-4 h-auto text-[#2f3336]'>
        ...
        <div className="svg-border"></div>
        <span className="hoverShareText" style={{display: 'none'}}>{shareValue}</span>
      </div>
    </div>
  );
}
