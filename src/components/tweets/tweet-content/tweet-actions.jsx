...
function TweetActions({ replyValue, retweetValue, reactValue, shareValue }) {
  ...
  return (
    <div className="tweet-actions">
      <div className="tweet-action hoverReply">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='hoverReplyIcon'>
      ...
      <div className="tweet-action hoverRetweet">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='hoverRetweetIcon'>
      ...
      <div className={`tweet-action hoverReact ${isLiked && 'isLikedBox'}`} onClick={handleClickOnLikeButton}>
      ...
      <div className="tweet-action hoverShare">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='hoverShareIcon'>
