    ...
    <>
      <div className="trends">
        ...
        <div className="trends__trends bg__gray">
          ...
          <div className="trends__trends-content">
            <div className="trends__trends-content-details-box">
              <div className="trends__trends-content-details">
                <span className="trending-localisation text-gray">Trending in Congo - Kinshasa</span>
                <span className="trending-theme">Congo</span>
                <span className="trending-posts-count text-gray">39.2K posts</span>
              </div>
          ...
          <Link to="/i/trends" className="show-more">Show more</Link>
        </div>
        ...
        <div className="trends__who-follow bg__gray">
          ...
          <div className="trends__who-follow-content" onClick={navigateToProfil}>
            ...
            <div>
              <Button content="Follow" backgroundColor="#EFF4F4" textColor="#0F1419" />
            </div>
          </div>
          <div className="trends__who-follow-content" onClick={navigateToProfil}>
            <Link to="account" className="link-to-profil">
          ...
          <Link to="/i/connect_people" className="show-more">Show more</Link>
        </div>

        <div className="trends__trends-more">
          <Link to="https://twitter.com/tos" target="_blank">Terms of Service</Link>
          <Link to="https://twitter.com/privacy" target="_blank">Privacy Policy</Link>
          <Link to="https://support.twitter.com/articles/20170514" target="_blank">Coockie Policy</Link>
          <Link to="https://help.twitter.com/resources/accessibility" target="_blank">Accessibility</Link>
          <Link to="https://business.twitter.com/en/help/troubleshooting/how-twitter-ads-work.html?ref=web-twc-ao-gbl-adsinfo&utm_source=twc&utm_medium=web&utm_campaign=ao&utm_content=adsinfo" target="_blank">Ads info</Link>
          <span>More <i class="ri-more-line"></i></span>
